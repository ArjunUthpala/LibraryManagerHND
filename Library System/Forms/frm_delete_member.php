...
<div class="container">
	<h3 align="center">Searching member for deleting</h3>
...
?>
	...
	<form action="../PHP/delete_member.php" method="post">
	<div class="container">
	<h3 align="center">Deleting Member</h3>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Member ID</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="first_name" required pattern="[A-Za-z]*" maxlength="15" size="20" value="<?php echo $row['first_name']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Middle Name</label>
			<div class="col-sm-10">
				<input type="text" name="middle_name" pattern="[A-Za-z]*" maxlength="15" size="20" value="<?php echo $row['middle_name']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Last Name</label>
			<div class="col-sm-10">
				<input type="text" name="last_name" required pattern="[A-Za-z]*" maxlength="20" size="25" value="<?php echo $row['last_name']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Member Type</label>
			<div class="col-sm-10">
					<input type="radio" name="member_type" value="student" <?php if ($row['member_type']=="student") echo "checked"?> disabled>Student
					<input type="radio" name="member_type" value="professor" <?php if ($row['member_type']=="professor") echo "checked"?> disabled>Professor
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="address1" required pattern="[A-Za-z0-9\s\-_,\.:;()''""\/]*" maxlength="20" size="25" value="<?php echo $row['address1']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Address line 2</label>
			<div class="col-sm-10">
				<input type="text" name="address2" required pattern="[A-Za-z\s\-_,\.:;()''""\/]*" maxlength="20" size="25" value="<?php echo $row['address2']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">City</label>
			<div class="col-sm-10">
				<input type="text" name="city" required pattern="[A-Za-z\s]*" maxlength="15" size="20" value="<?php echo $row['city']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Date</label>
			<div class="col-sm-10">
				<input type="date" name="register_date" required value="<?php echo $row['register_date']?>" readonly>
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-10">
