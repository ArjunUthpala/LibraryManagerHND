...
<body>
	...
	<div class="container">
		<h3 align="center">Searching book for editing</h3>
	...
	?>
	<form action="../PHP/edit_book.php" method="post">
	<div class="container" >
	<h3 align="center">Book Details</h3>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="booktitle" required pattern="[A-Za-z0-9\s\-_,\.:;()''""]*" maxlength="50" size="55" value="<?php echo $row['book_title']?>">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Book Author</label>
			<div class="col-sm-10">
				<input type="text" name="bookauthor1" required pattern="[A-Za-z\s]*" maxlength="25" size="30" value="<?php echo $row['author1']?>">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Book Author 2</label>
			<div class="col-sm-10">
				<input type="text" name="bookauthor2" pattern="[A-Za-z\s]*" maxlength="25" size="30" value="<?php echo $row['author2']?>">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">Publisher</label>
			<div class="col-sm-10">
				<input type="text" name="bookpub" required pattern="[A-Za-z\s]*" maxlength="20" size="25" value="<?php echo $row['publisher']?>">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2 col-form-label">ISBN Number</label>
			<div class="col-sm-10">
				<input type="text" name="bookisbn" pattern="[0-9\-]*" maxlength="17" size="20" placeholder="978-3-16-148410-0" value="<?php echo $row['isbn']?>">
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="bookprice" pattern="[0-9A-Za-z\s\.\$]*" maxlength="10" size="15" placeholder="$12.50" value="<?php echo $row['price']?>">
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-10">
